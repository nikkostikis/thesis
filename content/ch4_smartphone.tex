...
%\begin{tabular}{p{0.3\linewidth} p{0.3\linewidth} p{0.3\linewidth}}
	...
	\hline 	\hline 		
 	...
 	\gls{SmartPD1}$_{9}$ & 0.6905 & 	0.0503 \\ \hline
...
All values calculated as means from both hands for each control volunteer and patient are shown in tables \ref{table:allSmartH1} and \ref{table:allSmartPD1}, respectively. 
