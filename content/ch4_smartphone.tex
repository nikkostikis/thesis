...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.9\linewidth]{content/images/boxPlots_Smart1/boxAllA}
  \caption{$m_{\alpha}$ distribution comparison}
  \label{fig:boxAllA}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.9\linewidth]{content/images/boxPlots_Smart1/boxAllOm}
...
Throughout \gls{SmartCT2}, every time a patient participated in a session, an experienced neurologist would perform a full \gls{UPDRS} examination before the recording. The neurologist was the same for every patient, so no interrater variability should be taken into account. Time and availability limitations prevented multiple raters for all patients. 
...
\begin{tabular*}{1\textwidth}{@{\extracolsep{\fill}} c c c c }
	...
	\hline
	\\
	%not true from here down - I don't know why 9/9/2018
...
\begin{figure}[!hp]
  \centering
  \includegraphics[width=.8\linewidth]{content/images/boxPlots_Smart2/accMagn}
  \caption{$mag_{\alpha}$ distribution comparison}
  \label{fig:boxAccMag}
%\end{figure}
%\begin{figure}[!hpb]
%  \centering
  \includegraphics[width=.8\linewidth]{content/images/boxPlots_Smart2/rvelMagn}
  \caption{$mag_{\omega}$ distribution comparison}
  \label{fig:boxRvelMag}
\end{figure}
\begin{figure}[!hp]
  \centering
  \includegraphics[width=.8\linewidth]{content/images/boxPlots_Smart2/accSumDiff}
  \caption{$sd_{\alpha}$ distribution comparison}
  \label{fig:boxAccSumDiff}
%\end{figure}
%\begin{figure}[!hpb]
%  \centering
  \includegraphics[width=.8\linewidth]{content/images/boxPlots_Smart2/rvelAmp}
