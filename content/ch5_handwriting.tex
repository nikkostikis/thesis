...
%%%%%% Means testing inter-population YOH
\begin{table}[h]
\centering
...
%%%%%% Means testing intra-population HH vs LH
\begin{table}[h]
\centering
...
%\hlorange{NVV robustness - test/retest reliability}
